...
class Graph(object):
    ...
    def add_inter_graphs(self, proofnet: Dict[int, int]):
...
def traverse(graph: Graph, idx: str, forward_dict: Links, backward_dict: Links, upward: bool,
